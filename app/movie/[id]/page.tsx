          ...
          <div className="flex gap-7">
            ...
            <div className="flex flex-col">
              <div className="flex gap-3 items-center">
                ...
                <span
                  className={`flex flex-col p-2 text-white rounded-md ${movie?.vote_average < 5 ? `bg-red-700` : movie?.vote_average == 5 ? `bg-orange-700` : `bg-green-700`}`}
                >
                  {movie?.vote_average}
                </span>
              </div>
        ...
        <div className="flex flex-col mb-6 mt-6">
          ...
          <div className="grid grid-cols-4 mt-4 gap-4">
            {movieCast?.cast?.slice(0, 4).map((cast: ICastCard) => (
              <div className="card-container" key={cast?.id}>
                <CastCard cast={cast} />
              </div>
            ))}
          </div>
